                ...
                <dl>
                    ...
                    <dd>
                        <a href="?m=yrdwjbxx&c=index&a=show&id=<?php echo $r['id']?>&yrdwid=<?php echo $r['yrdwid']?>">
                            <span class="dwmc"><?php echo $r['dwmc'];?></span>
                            <span class="zpgw"><?php echo $r['zpgw'];?></span>
                            <span class="zprs"><?php echo $r['zprs'];?></span>
                            <span class="gzdy"><?php echo $r['gz'];?></span>
                            <span class="ly"><?php echo $r['sscl'];?></span>
                            <span class="fbsj"><?php echo date('m-d H:m',$r['cjsj']);?></span>
                        </a>
                    </dd>
