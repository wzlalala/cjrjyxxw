...
'cookie_pre' => 'RtPNf_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://localhost/cjrjyxxw/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://localhost/cjrjyxxw/statics/js/', //CDN JS
'css_path' => 'http://localhost/cjrjyxxw/statics/css/', //CDN CSS
'img_path' => 'http://localhost/cjrjyxxw/statics/images/', //CDN img
'app_path' => 'http://localhost/cjrjyxxw/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'InqIcF2TvYXsNaGVp7rP', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso_auth_key' => 'vSglmkuLAaaZ0NTgh7TxrWUS4DAHzqYx', //加密密钥
